...
async def startupmessage():
    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await jmthon.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/04fd7ae0f3efc78f2fb10.jpg",
                caption="⌯︙**بــوت مـاتركس يـعـمـل بـنـجـاح**  ✅ \n⌯︙**قـنـاة الـسـورس**  :  @VV399",
                buttons=[(Button.url("كروب مـاتركس", "https://t.me/NNN8X"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
    ...
    try:
        if msg_details:
            ...
            text = (
                message.text
                + "\n\n**⌯︙اهلا وسهلا لقد قمت باعاده تشغيل بـوت مـاتركس تمت بنجاح**"
            )
...
async def autojo():
    try:
        await jmthon(JoinChannelRequest("@VV399"))
        if gvar("AUTOEO") is False:
            ...
            try:
                ...
                pass
            try:
                await jmthon(JoinChannelRequest("@FFBBBF"))
            except BaseException:
                pass
    except BaseException:
        pass
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "مجموعة اشعارات مـاتركس ", jmthon, Config.TG_BOT_USERNAME, descript, photobt
        )
